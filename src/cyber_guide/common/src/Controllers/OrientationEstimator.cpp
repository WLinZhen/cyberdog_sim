...
//        this->_stateEstimatorData.result->orientation[0] = ori_w.CalculateAns(this->_stateEstimatorData.result->orientation[0]);
//        this->_stateEstimatorData.result->orientation[1] = ori_x.CalculateAns(this->_stateEstimatorData.result->orientation[1]);
//        this->_stateEstimatorData.result->orientation[2] = ori_y.CalculateAns(this->_stateEstimatorData.result->orientation[2]);
//        this->_stateEstimatorData.result->orientation[3] = ori_z.CalculateAns(this->_stateEstimatorData.result->orientation[3]);
    ...
    //    this->_stateEstimatorData.result->omegaBody[0] = omg_x.CalculateAns(this->_stateEstimatorData.result->omegaBody[0]);
    //    this->_stateEstimatorData.result->omegaBody[1] = omg_y.CalculateAns(this->_stateEstimatorData.result->omegaBody[1]);
    //    this->_stateEstimatorData.result->omegaBody[2] = omg_z.CalculateAns(this->_stateEstimatorData.result->omegaBody[2]);
    ...
    //    this->_stateEstimatorData.result->aBody[0] = acc_x.CalculateAns(this->_stateEstimatorData.result->aBody[0]);
    //    this->_stateEstimatorData.result->aBody[1] = acc_y.CalculateAns(this->_stateEstimatorData.result->aBody[1]);
    //    this->_stateEstimatorData.result->aBody[2] = acc_z.CalculateAns(this->_stateEstimatorData.result->aBody[2]);
    this->_stateEstimatorData.result->aWorld =
            this->_stateEstimatorData.result->rBody.transpose() *
            this->_stateEstimatorData.result->aBody;
}
